...
class Line:
    ...
    def _handle_station(self, value):
        ...
        #logger.info("defined stations:" + str(self.stations))
    ...
    def process_message(self, message):
        ...
        if message.topic() == "com.udacity.transfomed.stations": # Set the conditional correctly to the stations Faust Table
            try:
